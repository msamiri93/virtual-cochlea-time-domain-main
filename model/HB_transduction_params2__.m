function HB = HB_transduction_params2__(MP, dZ)
...
function HB = set_HB_props_at_two_locations(MP,loc)%%%%%%%%%%%%%
    ...
    elseif strcmpi(loc(1),'B')
        ...
        HB.Xo = 0.4e-3;        % this determines the initial state, increasing Xo decreases po,rest  
